...
let byName = false;
let byGender = false;
const renderMoviesCuadricula = document.getElementById("renderMoviesCuadricula");
const renderMoviesLista = document.getElementById("renderMoviesLista");
...
const movie1 = new Movie(
  ...
  "https://www.youtube.com/embed/LJgYQixw4gI"
);
const movie2 = new Movie(
  ...
  "Bill Holderman",
  "ATP",
  "cuandoellasquierenmas.jpg",
  "La esperada secuela sigue a nuestras cuatro mejores amigas mientras llevan su club de lectura a Italia para hacer el divertido viaje de chicas que nunca tuvieron. Cuando las cosas se salen de control y se revelan secretos, sus relajantes vacaciones se convierten en una aventura única en la vida.",
  "https://www.youtube.com/embed/7l8f6IjX5ag"
);
const movie3 = new Movie(
  ...
  "Jim Strouse",
  "ATP",
  "amoraprimermensaje.jpg",
  "¿Qué pasaría si un mensaje de texto al azar te condujera al amor de tu vida? En esta comedia romántica, ante la pérdida de su prometido, Mira Ray envía una serie de mensajes de texto románticos a su antiguo número de teléfono... sin darse cuenta de que el número había sido reasignado al nuevo teléfono del trabajo de Rob Burns. Rob, periodista, queda cautivado por la honestidad de los textos. Cuando le asignan la tarea de escribir un perfil de la megaestrella Celine Dion (interpretándose a sí misma en su primer papel cinematográfico), le pide ayuda para averiguar cómo conocer a Mira en persona... y conquistar su corazón.",
  "https://www.youtube.com/embed/XC6ZnoGg3Rg"
);
const movie4 = new Movie(
  ...
  "https://www.youtube.com/embed/ox9jhbW8W7c"
);
const movie5 = new Movie(
  ...
  "https://www.youtube.com/embed/04FpTLWNn8o"
);
const movie6 = new Movie(
  ...
  "https://www.youtube.com/embed/_OYDluP89-8"
);
const movie7 = new Movie(
  ...
  "ATP",
  "eltriunfo.jpg",
  "Etienne (Kad Meran) es un entrañable actor que dirige un taller de teatro en un centro penitenciario. Allí reúne a un particular grupo de internos para representar la famosa obra de Samuel Beckett Esperando a Godot. Cuando consigue la autorización para realizar una gira fuera de la cárcel con su pintoresca troupe de actores, a Etienne se le presentará finalmente la ocasión de prosperar.",
  "https://www.youtube.com/embed/tjJryOoI35U"
);
...
const movie9 = new Movie(
  ...
  "https://www.youtube.com/embed/qAkCoX760xQ"
);
const movie10 = new Movie(
  ...
  "https://www.youtube.com/embed/sGjJhdTqfZc"
);
...
const movie13 = new Movie(
  ...
  "https://www.youtube.com/embed/vm24XO9TCMg"
);
const movie14 = new Movie(
  ...
  "https://www.youtube.com/embed/Td6pDaF5hdQ"
);
const movie15 = new Movie(
  ...
  "https://www.youtube.com/embed/T-iN3U-RNlM"
);
const movie16 = new Movie(
  16,
  ...
  "https://www.youtube.com/embed/GN0Yi3xNmAU"
);
const movie17 = new Movie(
  17,
...
const movie19 = new Movie(
  ...
  "https://www.youtube.com/embed/BNgEaNZPFCA"
);
const movie20 = new Movie(
  ...
  "https://www.youtube.com/embed/IaqvH0eaYsE"
);
...
function searchMoviesName() {
  if (textoBuscar.value === "") {
    ...
    let resultado = movies.filter((movie) =>
      movie.title.toUpperCase().includes(txt)
    );
    if (resultado.length != 0) {
      ...
      resultado.forEach((movie) => {
        ...
        if (id === 0) {
          //para mostrar en sinopsis la primera pelicula de la busqueda
          id = movie.id;
        }
      });
      ...
      labelBuscar1.innerHTML =
        " << Se muestran las películas con el filtro ingresado";
      labelBuscar1.classList.remove("disableElement");
      textoBuscar.focus();
    } else {
      labelBuscar1.innerHTML =
        " << No se encontro ninguna película que coincida con el texto ingresado";
      labelBuscar1.classList.remove("disableElement");
      textoBuscar.focus();
    }
  }
...
function searchMoviesGender() {
  if (selectBuscar.value === "0") {
    ...
    let resultado = movies.filter((movie) =>
      movie.gender.toUpperCase().includes(txt)
    );
    if (resultado.length != 0) {
      let id = 0;
      foundMovies.length = 0;
